...
cpdef tuple estimation(
    ...
    params = fmin(target_function, x0, args=(p, q, Q, P, cons, y), disp=0)
...
cpdef np.float64_t target_function(
...
cpdef np.float64_t loglikelihood(
...
def estimation_py(y, x0, p, q, Q, P, cons):
    """ 
    NOT YET WORKING !
    Estimator 
    """    
